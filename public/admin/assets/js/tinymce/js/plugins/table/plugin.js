...
(function () {
    ...
    var applyDataToElement = function (editor, tableElm, data) {
	  ...
	  if(data.tstriped) attrs.class += ' '+data.tstriped;
	  if(data.thoverable) attrs.class += ' '+data.thoverable;
	  if(data.tbordered) attrs.class += ' '+data.tbordered;
	  if(data.tdark) attrs.class += ' '+data.tdark;
	  if(data.tcompact) attrs.class += ' '+data.tcompact;
    ...
    var open = function (editor, insertNewTable) {
	  ...
	  //if (classes.length > 0) {
        if (data.class) {
		  ...
		  if(data.class.includes('table-striped')) data.tstriped = 'table-striped';
		  if(data.class.includes('table-hover')) data.thoverable = 'table-hover';
		  if(data.class.includes('table-bordered')) data.tbordered = 'table-bordered';
		  if(data.class.includes('table-dark')) data.tdark = 'table-dark';
		  if(data.class.includes('table-sm')) data.tcompact = 'table-sm';
        }
      //}
	 // console.log(data);
      var generalPanel = {
