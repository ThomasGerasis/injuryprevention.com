...
(function () {
    ...
    var isCodeSample = function (elm) {
      return elm && elm.nodeName === 'PRE' && elm.className.indexOf('shortcode-') !== -1;
    };
    ...
    var insertCodeSample = function (editor, language, code) {
      editor.undoManager.transact(function () {
        ...
        return node.fold(function () {
          editor.insertContent('<pre id="__new" class="shortcode-' + language + '">' + code + '</pre>');
          editor.selection.select(editor.$('#__new').removeAttr('id')[0]);
        }, function (n) {
          editor.dom.setAttrib(n, 'class', 'shortcode-' + language);
          n.innerHTML = code;
    ...
    var getCurrentLanguage = function (editor, fallback) {
      ...
      return node.fold(function () {
        ...
        var matches = n.className.match(/shortcode-(\w+)/);
    ...
    var register$1 = function (editor) {
      editor.addCommand('foxshortcodepl', function () {
    ...
    var isCodeSampleSelection = function (editor) {
      ...
      return editor.dom.is(node, 'pre[class*="shortcode-"]');
    };
    var register = function (editor) {
      var onAction = function () {
        return editor.execCommand('foxshortcodepl');
      };
      editor.ui.registry.addToggleButton('foxshortcodepl', {
        icon: 'code-sample',
      ...
      editor.ui.registry.addMenuItem('foxshortcodepl', {
        text: 'Code sample...',
        icon: 'code-sample',
        onAction: onAction
      });
    ...
    function Plugin () {
      global$2.add('foxshortcodepl', function (editor) {
        setup(editor);
        register(editor);
        register$1(editor);
