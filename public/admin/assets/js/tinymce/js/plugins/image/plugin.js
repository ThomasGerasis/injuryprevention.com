...
(function () {
    ...
    var getFoxBase = function (editor) {
		return editor.getParam('fox_base_url');
    };
    ...
    var makeDialog = function (helpers) {
      ...
      return function (info) {
		var eximg = fromImageData(info.image);
		if(eximg.src.value){ //existing image
    ...
    var Dialog = function (editor) {
      ...
      var open = function () {
        collect(editor).then(makeDialog(helpers)).then((value) => {console.log(value);if(value.url){editor.windowManager.openUrl(value);}else{editor.windowManager.open(value)};});//{editor.windowManager.open);
      };
      return { open: open };
    };
