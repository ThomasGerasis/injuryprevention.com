        ...
        return {
            ...
            onOk: function() {
                ...
                if (b.info) {
                    ...
                    bootstrapClass += this.getValueOf('bootstrapCssTab', 'condensed') ? ' table-sm' : '';
                    bootstrapClass += this.getValueOf('bootstrapCssTab', 'darkRows') ? ' table-dark' : '';
	            ...
	            },
	            {
	                ...
	                elements: [
						...
						},
						{
							...
							children: [
								...
								},
								{
									...
									setup		: function(a){
										var tableClasses = (a.getAttribute('class')).split(' ');
										this.setValue(mj_in_array('table-sm', tableClasses));
	                                }
								}
							]
						},
						{
							...
							setup		: function(a){
								var tableClasses = (a.getAttribute('class')).split(' ');
								this.setValue(mj_in_array('table-dark', tableClasses));
							}
						},
					]
	            }
