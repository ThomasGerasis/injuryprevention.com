CKEDITOR.dialog.add( 'analysilinkDialog', function( editor ) {
	return {
				...
				elements: [
					
					{
						...
						onLoad: function(api) {
							...
							$.ajax({
								type: 'GET',
								//url: 'http://localhost/admin.foxbet.gr/admin/admin/ajaxData/getAnalysiLinks',
								url: 'https://adminfx.foxbet.gr/admin/ajaxData/getAnalysiLinks',
								dataType: 'json',
