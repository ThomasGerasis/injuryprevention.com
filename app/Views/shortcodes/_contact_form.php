<form class="contact-form mt-5 mb-5 text-center" action="<?=base_url('sendEmail')?>" method="post" accept-charset="utf-8" id="contact-form">
    <div class="input-group">
        <input type="text" required name="name" class="form-control me-2" id="name" placeholder="John">
        <input type="text" required name="surname" class="form-control" id="surname" placeholder="Doe">
    </div>
    <input type="email" name="email" required class="form-control mt-2" id="email" placeholder="johndoe@example.com">
