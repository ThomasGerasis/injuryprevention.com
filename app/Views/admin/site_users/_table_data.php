...
<div class="table-responsive">
	<table class="table datatable-basic dataTable no-footer table-hover table-bordered table-striped ci_datatable">
		<thead class="table-dark">
			<tr>
				<th>id</th>
				<th class="do-sorting <?php echo ($sortingColumn == 'username' ? $sortingType : 'sorting'); ?>" data-sorting-col="username" data-sorting-type="<?php echo ($sortingColumn == 'username' ? $orderTypeOpposite : $orderType); ?>">Username</th>
				<th>Mobile</th>
				<th>Email</th>
...
<!--					<td data-title="Username">--><?php //echo $item['username']; ?><!--</td>-->
					<td data-title="Mobile"><?php echo $item['mobile_number']; ?></td>
					...
					<td data-title="Active">
						<?php if(!empty($item['is_active'])){?>
							...
							<a href="<?php echo base_url('admin/siteUsers/deactivate/'.$item['id']);?>" class="btn bg-danger btn-sm btn-confirm-action" data-confirmation="Do you want to deactivate the user <?php echo $item['username'];?>?" title="Deactivate"><i class="icon-user-block"></i></a>
						<?php }else{?>
							NO <?php /*<i class="icon-user-block text-danger" data-toggle="tooltip" title="Inactive"></i>*/?>
							<a href="<?php echo base_url('admin/siteUsers/activate/'.$item['id']);?>" class="btn bg-success btn-sm btn-confirm-action" data-confirmation="Do you want to activate the user <?php echo $item['username'];?>?" title="Activate"><i class="icon-user-check"></i></a>
						<?php }?>
					</td>
				</tr>
			<?php } ?>
