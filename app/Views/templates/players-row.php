...
<div class="position-relative players-swiper-container swiper-container margin-top-0 margin-top-xl-20 w-100" data-breakpoint="type2" data-prefix="players" id="players-swipe-<?php echo $randomId;?>">
...
<span class="font-fff font-weight-normal d-flex d-lg-none align-items-center mt-4 w-100 font-fff-opacity-75 text-decoration-none justify-content-center font-size-09rem">
