    ...
    <div class="swiper players-swiper">
        <div class="swiper-wrapper">
            <?php foreach ($players as $player) {
                ...
                if(empty($playerDetails['logo'])){
                    continue;
                }
                ?>
                <div class="swiper-slide player-row-slide d-flex align-items-center text-center font-fff" data-name="<?=$playerDetails['name']?>" data-img="<?php echo base_url('assets/img/players/'.$playerDetails['logo'].'.svg'); ?>">
