...
<head>
    ...
    <link rel="stylesheet" href="/dist/css/main.css?v=2.51<?php echo ENVIRONMENT == 'development' ? time() : '';?>">
    <link rel="stylesheet" href="/dist/css/customSwiper.css?v=2.71<?php echo ENVIRONMENT == 'development' ? time() : '';?>">
